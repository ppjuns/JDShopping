package com.ppjun.jdshopping.weight;
...
import com.ppjun.jdshopping.R;
import com.ppjun.jdshopping.Utils.UiUtils;

/**
 * @Package :com.ppjun.jdshopping.weight
 * @Description :
 * @Author :Rc3
 * @Created at :2016/8/30 10:08.
 */
public class DoubleScrollViewWrapper extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        heitht = UiUtils.getHeight(context) - UiUtils.getStatusBarHeight(context) - UiUtils.dp2px(context, padding);
        a.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isSetted) {
            ...
            LinearLayout layout = (LinearLayout) wrapper.getChildAt(1);
            pageTwo = layout.getChildAt(1);
